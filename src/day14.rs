...
mod test {
    ...
    static EX4: &str = "2 VPVL, 7 FWMGM, 2 CXFTF, 11 MNCFX => 1 STKFG\n\
    ...
    static EX5: &str = "171 ORE => 8 CNZTR\n\
    ...
    fn test_14_ex1() -> Result<(), Box<dyn Error>> {
        let input = util::parse_lines(EX1)?;
    ...
    fn test_14_ex2() -> Result<(), Box<dyn Error>> {
        let input = util::parse_lines(EX2)?;
        assert_eq!(super::day14a(&input), 165);
        Ok(())
    }
    ...
    fn test_14_ex3() -> Result<(), Box<dyn Error>> {
        ...
        assert_eq!(super::day14a(&input), 13_312);
        Ok(())
    }
    ...
    fn test_14_ex4() -> Result<(), Box<dyn Error>> {
        ...
        assert_eq!(super::day14a(&input), 180_697);
        Ok(())
    }
    ...
    fn test_14_ex5() -> Result<(), Box<dyn Error>> {
        ...
        assert_eq!(super::day14a(&input), 2_210_736);
        Ok(())
    }
